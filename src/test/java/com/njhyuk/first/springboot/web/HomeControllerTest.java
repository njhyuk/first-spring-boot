...
import com.njhyuk.first.springboot.config.auth.SecurityConfig;
...
public class HomeControllerTest {
    ...
    public void will_return_to_hello() throws Exception {
        String hello = "hello";
    ...
    @Test
    @WithMockUser(roles = "USER")
    public void will_return_to_helloDto() throws Exception {
        String name = "hello";
        int amount = 1000;
